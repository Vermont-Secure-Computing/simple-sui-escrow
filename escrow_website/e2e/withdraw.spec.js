...
console.log(
  ...
  // ========================================================
  // WITHDRAW / CANCEL - PARTY A
  // ========================================================

  console.log(
    "\n=== Party A Withdraw Before Complete ==="
  );

  // Only Party A has deposited.
  ...
  console.log(
    "✓ PASS: Withdraw & Cancel Escrow button visible"
  );

  const withdrawApprovalPromise =
    context.waitForEvent("page");

  await withdrawButton.click();

  console.log(
    "✓ PASS: Withdraw & Cancel Escrow clicked"
  );

  const withdrawApprovalPage =
    await withdrawApprovalPromise;

  await withdrawApprovalPage.waitForLoadState();

  console.log(
    "✓ PASS: Withdraw approval opened"
  );

  const withdrawApproveButton =
    withdrawApprovalPage.locator(
      'button:has-text("APPROVE")'
    );

  await expect(
    withdrawApproveButton.first()
  ).toBeVisible();

  console.log(
    "✓ PASS: Withdraw approve button found"
  );

  await withdrawApproveButton
    .first()
    .dispatchEvent("click")
    .catch((error) => {
      if (
  ...
  console.log(
    "✓ PASS: Withdraw approval triggered"
  );
  ...
  console.log(
    "✓ PASS: Escrow status is CANCELLED"
  );
  ...
  console.log(
    "✓ PASS: Party A deposited amount reset to 0"
  );
  ...
  console.log(
    "✓ PASS: Withdraw transaction succeeded"
  );
  ...
  console.log(
    "✓ PASS: Withdraw button removed after cancellation"
  );
  ...
  console.log(
    "WITHDRAW / CANCEL LIFECYCLE: PASS"
  );

  console.log(
    "Create → Deposit A → Withdraw → Cancelled"
  );
