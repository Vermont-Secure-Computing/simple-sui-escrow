...
console.log(
  ...
  // ========================================================
  // SECURITY: PARTY B CANNOT WITHDRAW PARTY A DEPOSIT
  // ========================================================
  ...
  // Party A has deposited 0.012 SUI.
  // Escrow must still be CREATED.
  await expect(
    page.getByText(
      "CREATED",
      { exact: true }
  ...
  const stateAfterPartyBSwitch =
    await sendAutomation(
      page,
      {
        type: "SUI_TEST_WALLET_AUTOMATION",
        action: "GET_STATE",
        id: "security-state-after-party-b-switch",
      }
    );
  ...
  // ========================================================
  // VERIFY PARTY B CANNOT WITHDRAW PARTY A DEPOSIT
  // ========================================================
  ...
  console.log(
    "✓ PASS: Party A deposit still locked"
  );
  ...
  console.log(
    "✓ PASS: Party B cannot access Party A withdraw action"
  );
  ...
  console.log(
    "UNAUTHORIZED WITHDRAW UI SECURITY: PASS"
  );

  console.log(
    "Party A Deposit → Party B → Withdraw Blocked"
  );
